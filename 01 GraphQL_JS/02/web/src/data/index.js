  ...
  reviews: [
    {
      ...
      title: "Must Read",
      rating: 5,
      comment: "A must-read for any entrepreneur who wants to make a difference.",
      user: {
        name: "jane",
      },
      book: {
    ...
    },
    {
      ...
      title: "stimulating",
      rating: 5,
      comment: "Zero to One is a refreshing intellectual deep dive into the motives behind entrepreneurship.",
      user: {
        name: "knowthen",
      },
      book: {
    ...
    },
    {
      ...
      rating: 4,
      comment: "After reading this book, I feel like I have a clue about design!",
      user: {
        name: "joe",
      },
      book: {
  ...
  books: [
    {
      ...
      description:
        "The billionaire Silicon Valley entrepreneur behind such companies as PayPal and Facebook outlines an innovative theory and formula for building the companies of the future by creating and monopolizing new markets instead of competing in old ones. 200,000 first printing.",
      rating: 5,
      imageUrl: "//books.google.com/books/content?printsec=frontcover&img=1&edge=curl&source=gbs_api&zoom=0&id=POOJDQAAQBAJ",
      authors: [
        {
          name: "Peter Thiel",
        },
      ...
      reviews: [
        {
          ...
          user: {
            name: "knowthen",
            imageUrl: "//www.gravatar.com/avatar/2a964ae2a7deac996cc96a4a03d36af2?s=50",
          },
        },
        {
          id: "2",
          ...
          user: {
            name: "joe",
            imageUrl: "//www.gravatar.com/avatar/66fb4a60ad325eb5ded7c3e984cb870c?s=50",
          },
        },
        {
          id: "3",
          ...
          user: {
            name: "jane",
            imageUrl: "//www.gravatar.com/avatar/0092273ac34f8cf86995e46ba9fef42a?s=50",
          },
        },
      ],
    },
    {
      ...
      description:
        'Looks at classical design principles and techniques for Web designers using a "reverse-engineering" process, with information on such topics as color, proportion, white space, composition, and typographic etiquette.',
      rating: 4.333333333333333,
      imageUrl: "//books.google.com/books/content?printsec=frontcover&img=1&edge=curl&source=gbs_api&zoom=0&id=9ZNHCElMv9EC",
      authors: [
        {
          name: "David Kadavy",
        },
