...
insert into
  hb.book_author(id, book_id, author_id)
values
  (1, 1, 2),
  (2, 1, 3),
  (3, 2, 1);
...
insert into
  hb.review(id, user_id, book_id, rating, title, comment)
values
  (
    1,
    1,
    ...
    4,
    'read early',
    'I wish that I''d found this book a long time ago'
  ),
  (
    2,
    2,
